...
In this Chapter, we see a basic example that demonstrates how the blueprint and the dependency graph work: Euclid's proof of the infinitude of primes. Credits to \url{https://github.com/thefundamentaltheor3m/EPFLDemo2}.
